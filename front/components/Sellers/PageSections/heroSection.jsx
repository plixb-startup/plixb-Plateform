...
import Invest from "../../../public/assets/in.png"
            ...
            <div className="mt-20">
              <div>
                <a href="#" className="inline-flex space-x-4">
                  <span className="rounded bg-indigo-50 px-2.5 py-1 text-sm font-semibold text-blue-600">
                    What's new
                  </span>
              ...
              <div className="mt-6 sm:max-w-xl">
                <h1 className="text-4xl font-bold tracking-tight text-gray-900 sm:text-5xl">
                  Get acquired fast and for the maximum price. Founder friendly.
                  No fees. Always private.
                </h1>
                <p className="mt-6 text-xl text-gray-500">
                  List your details, connect your metrics, and get eyes on your
                  startup instantly. Hire approved advisors to help you sell or
                  skip straight to the conversation. Connect with 100,000+
                  vetted buyers to get your startup acquired in as little as 30
                  days.
                </p>
              </div>
              {/* <form action="#" className="mt-12 sm:flex sm:w-full sm:max-w-lg">
                ...
                <div className="mt-4 sm:mt-0 sm:ml-3"></div>
              </form> */}
              <button
                type="submit"
                className="block mt-10 w- rounded-md border border-transparent bg-blue-600 px-5 py-3 text-base font-medium text-white shadow hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2 sm:px-10"
              >
                Join now
              </button>
              {/* <div className="mt-6">
